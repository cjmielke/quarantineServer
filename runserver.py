...
class MyRequestHandler(WSGIRequestHandler):
    ...
    def log_request(self, code='-', size='-'):
        if 'GET /client/update.json' in self.raw_requestline:
            return
...
if not debug:
    ...
    # this stopped working under uWSGI
...
def main():
    # host of 0.0.0.0 makes debug server visible over network! Use sparingly
    host = '127.0.0.1'
